...
/**
 * Génère les resources utilisées par la classe PostalAddressFormatter à partir des données qui figurent sur le
 * site google http://i18napis.appspot.com/address.
 *
...
class PostalAddressFormatsHelper
{
     ...
     * - do_si (1) : Province / ville (Corée du sud, "do" désigne des provinces, "si" désigne des métropoles / des villes)
     ...
     * - state (15) : État
     * (cf. http://basementgeographer.com/province-state-department-periphery-names-for-first-order-administrative-divisions-around-the-world/)
     *
